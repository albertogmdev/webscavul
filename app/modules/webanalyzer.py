...
def analyze_metatags(webpage: WebPage, headers: dict):
    ...
    # referer meta tag no-referrer-when-downgrade, strict-origin-when-cross-origin, no-referrer y strict-origin
    meta_referrer = None
    is_header = False
    ...
    elif meta_referrer.lower() not in ['no-referrer', 'strict-origin-when-cross-origin', 'no-referrer-when-downgrade', 'strict-origin']:
        webpage.add_vulnerability(
            Vulnerability(
